...
class EmbeddingAllReduceRMSNormStaticFP8Pattern(AllReduceRMSNormPattern):
...
class MiddleAllReduceRMSNormStaticFP8Pattern(AllReduceRMSNormPattern):
    ...
    def register(self, pm_pass: PatternMatcherPass):
        ...
        def replacement(
            ...
            half_result = torch.empty_like(reduce_scatter, dtype=FP8_DTYPE)
...
class MiddleAllReduceRMSNormStaticFP8PatternExtra(AllReduceRMSNormPattern):
...
class LastAllReduceRMSNormStaticFP8Pattern(AllReduceRMSNormPattern):
...
class LastAllReduceRMSNormStaticFP8PatternExtra(AllReduceRMSNormPattern):
