...
class ParallelConfig:
    ...
    enable_sequence_parallel: bool = False  # If user enables sequence parallel. If enabled, it uses tensor_parallel_size as sequence parallelism
...
class SpeculativeConfig:
    ...
    def create_draft_parallel_config(
        ...
        draft_parallel_config = ParallelConfig(
            ...
            enable_sequence_parallel = target_parallel_config.enable_sequence_parallel,
